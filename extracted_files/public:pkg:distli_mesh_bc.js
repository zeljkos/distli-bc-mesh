...
export class OrderBook {
    ...
    cancel_order(order_id) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.orderbook_cancel_order(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @param {string} order_id
    ...
    update_order_quantity(order_id, new_quantity) {
        const ptr0 = passStringToWasm0(order_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.orderbook_update_order_quantity(this.__wbg_ptr, ptr0, len0, new_quantity);
        return ret !== 0;
    }
    /**
     * @param {string} asset
     ...
     * @returns {string}
     */
    execute_cross_network_trade(asset, quantity, price, buyer, seller) {
        let deferred4_0;
        let deferred4_1;
        try {
            const ptr0 = passStringToWasm0(asset, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(buyer, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(seller, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            const ret = wasm.orderbook_execute_cross_network_trade(this.__wbg_ptr, ptr0, len0, quantity, price, ptr1, len1, ptr2, len2);
            deferred4_0 = ret[0];
            deferred4_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {number}
     */
    clear_trader_orders(trader) {
        const ptr0 = passStringToWasm0(trader, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.orderbook_clear_trader_orders(this.__wbg_ptr, ptr0, len0);
        return ret >>> 0;
    }
    /**
     * @param {string} order_id
    ...
    get_order(order_id) {
        ...
        try {
            const ptr0 = passStringToWasm0(order_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.orderbook_get_order(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
